...
#process.GlobalTag.globaltag = "GR_P_V24::All"
...
process.TimingStudy = cms.EDAnalyzer("TimingStudy",
                                     ...
                                     fileName = cms.string("MB_Run2011B_RECO.root"),
...
'/store/data/Run2011B/MinimumBias/RECO/PromptReco-v1/000/178/160/8EA0C6C4-1DF5-E011-A3BF-E0CB4E55365C.root'
)
)
